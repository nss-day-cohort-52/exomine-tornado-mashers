export const database = {
    ...
    governors: [
        ...
        { id: 10, name: "Oshadadam", isActive: true, colonyId: 4 },
        { id: 11, name: "Passel Argente", isActive: true, colonyId: 5 },
        { id: 12, name: "Mina Bonteri", isActive: true, colonyId: 6 },
        { id: 13, name: "Lux Bonteri", isActive: true, colonyId: 6 },
        { id: 14, name: "Mee Deechi", isActive: true, colonyId:7 },
        { id: 15, name: "Riyo Chuchi", isActive: true, colonyId:8 },
        { id: 16, name: "Chi Eekway Papanoida", isActive: true, colonyId:8 },
        { id: 17, name: "Lolo Purs", isActive: true, colonyId:9 },
        { id: 18, name: "Anaconda Farr", isActive: true, colonyId:9 },
        { id: 19, name: "Tikkes", isActive: false, colonyId:10 },
        { id: 20, name: "Meena Tills", isActive: true, colonyId:10 },
        { id: 21, name: "Ainlee Teem", isActive: true, colonyId:1 }
    ],
